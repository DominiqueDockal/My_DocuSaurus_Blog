...
4. Deployment
   ...
   The website is deployed automatically through the prepared GitHub Actions workflow when changes are pushed to the main branch.
...
This website is automatically deployed to GitHub Pages using a prepared GitHub Actions workflow. Whenever a commit is pushed to the main branch, the deployment pipeline runs and publishes the latest version of the site.